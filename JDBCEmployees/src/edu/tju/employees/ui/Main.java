...
public class Main implements ActionListener {
	...
	private JScrollPane getLstDeptList() throws SQLException {
		if (lstDeptList == null) {
	...
	private void updateLstDeptList() throws SQLException {
		List<Departments> list = deptDAO.findAll();
		Object[] objs = list.toArray();
	...
	private JFrame getJFrame() throws SQLException {
		if (jFrame == null) {
			jFrame = new JFrame();
